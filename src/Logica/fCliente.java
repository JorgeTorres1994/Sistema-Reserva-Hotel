...
public class fCliente {
    ...
    public boolean insertar(vCliente dts) {
        //DESPUES DE INSERTAR A LA PERSONA, SE INSERTA AL CLIENTE 
        ...
        sSQL2 = "insert into cliente (idpersona,codigo_cliente)"
                + "values ((select idpersona from persona order by idpersona desc limit 1),?)";//mostrar el idpersona de forma descendiente, mostrando el ultimo idpersona
        ...
        try {
            ...
            int n = pst.executeUpdate(); //si n es diferente de cero, si se logro insertar la persona

            if (n != 0) {
                int n2 = pst2.executeUpdate();//si n es diferente de cero, si se logro insertar al cliente
